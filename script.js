...
for (let temporada of bd.temporadas){
    ...
    <div class="temporada">
                ...
                <div class="info">
                    ...
                    <div class="subtitulo">${temporada.exibicao} | ${temporada.numero_episodios}</div>
    ...
    document.querySelector(`#btn-${n}`).addEventListener("click", 
        function (ev) {
            mostarEpisodios(ev, n)
    }
    );
}

function mostarEpisodios (ev, id){
    ev.preventDefault();
